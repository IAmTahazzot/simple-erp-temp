...
export const BaseLayout = ({children, head, backgroundColor}: BaseLayoutProps) => {
  ...
  return (
    <View style={styles.container}>
      <Animated.View
        style={[styles.headWrapper, {opacity: headerOpacity, transform: [{translateY: headerTranslateY}]}]}>
        {head}
      </Animated.View>
